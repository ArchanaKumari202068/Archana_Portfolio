  ...
  return (
    <>
      <div className="container" id="Projects">
        ...
        <div className="Cards">
          <ProjectCards
            aboutProject=" ● Developed web UI/UX through Figma and designedprototypes .
                          ● Used ReactJS for Frontend. 
                          ● Worked with existing API’s to access necessary
                          information from the backend. 
                          ● Collaborated
                          with teammates and updated application versions using
                          Git and Git."
          ...
          />
          <ProjectCards
            aboutProject="● Developed a StackOverflow clone using MERN stack
            (MongoDB, Express.js, React, Node.js).
            
            ● Implemented user authentication, question posting,
            and answer functionalities using React for the
            frontend and Express.js for the backend.
            
            ● Utilized MongoDB for database management to store
            and retrieve user-generated questions and answers.
            
            ● Integrated responsive design and intuitive UI for
            seamless user experience in line with the original
          ...
          <ProjectCards
            aboutProject=" ● Developed a web application using Django web framework, Python, HTML/CSS, SQLite database.
            ● Designed and developed the frontend with help of CSS and JS, resulting in a responsive and polished user interface.
            ● Contributed to the project's development, writing reusable and maintainable code, optimizing database queries.
          ...
          <ProjectCards
            aboutProject=" ● Used data from Kaggle for analysis.
          ...
          />
          <ProjectCards
            aboutProject=" ● Used request module to get information from an API
